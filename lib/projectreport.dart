...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Detailed Project Report',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 30),),
      centerTitle: true,),
      body: Center(
        child: Column(
...
class DevelopmentProcessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Development Process',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 30),),
      ),
      body: Padding(
